...
public class ParticipantResource {
    ...
    public List<Participant> getAllParticipants(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all Participants");
        return participantRepository.findAllWithEagerRelationships();
    }
