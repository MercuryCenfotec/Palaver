...
import com.mercury.palaver.service.dto.PasswordChangeDTO;
import com.mercury.palaver.service.dto.UserDTO;
import com.mercury.palaver.web.rest.errors.*;
import com.mercury.palaver.web.rest.vm.KeyAndPasswordVM;
import com.mercury.palaver.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public Optional<User> registerAccountRetrieve(@Valid @RequestBody ManagedUserVM managedUserVM) {
        if (!checkPasswordLength(managedUserVM.getPassword())) {
            throw new InvalidPasswordException();
        }
        User user = userService.registerUser(managedUserVM, managedUserVM.getPassword());
