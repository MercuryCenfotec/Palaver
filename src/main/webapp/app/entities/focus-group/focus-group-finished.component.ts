...
export class FocusGroupFinishedComponent {
...
export class FocusGroupFinishedPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ focusGroup }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(FocusGroupFinishedComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
