...
describe('Service Tests', () => {
    describe('UserApp Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new UserApp(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a UserApp', async () => {
            ...
            it('should update a UserApp', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
            ...
            it('should return a list of UserApp', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        identificationNumber: 'BBBBBB',
            ...
            it('should delete a UserApp', async () => {
