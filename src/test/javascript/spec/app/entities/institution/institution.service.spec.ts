...
describe('Service Tests', () => {
    describe('Institution Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(InstitutionService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Institution(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Institution', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        description: 'BBBBBB',
            ...
            it('should delete a Institution', async () => {
